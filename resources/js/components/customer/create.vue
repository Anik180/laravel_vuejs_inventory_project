...
<div>
   <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active float-right">Add Customer</li>
        </ol>
     <div class="card-header">
      <router-link class="btn btn-info" to="/customer" style="float: right;"><i class="fas fa-globe"></i>All Customer</router-link>
